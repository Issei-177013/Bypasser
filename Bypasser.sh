...
download_and_extract_rathole() {
    ...
    if [[ "$ARCH" == "x86_64" ]]; then
    	DOWNLOAD_URL='https://github.com/Issei-177013/Bypasser/raw/main/core/rathole.zip'
    fi
...
display_logo() {   
    ...
    cat << "EOF"
__________                                                 
\______   \___.__.___________    ______ ______ ___________ 
 |    |  _<   |  |\____ \__  \  /  ___//  ___// __ \_  __ \
 |    |   \\___  ||  |_> > __ \_\___ \ \___ \\  ___/|  | \/
 |______  // ____||   __(____  /____  >____  >\___  >__|   
        \/ \/     |__|       \/     \/     \/     \/       
EOF
    echo -e "${NC}${GREEN}"
...
SCRIPT_URL="https://github.com/Issei-177013/Bypasser/raw/main/bypasser.sh"
...
install_modified_core(){
	echo
	DOWNLOAD_URL='https://github.com/Issei-177013/Bypasser/raw/main/core/rathole_modified.zip'
